...
* `IntensitySampleX` - normalized log2 transformed intensity of the peptide in SampleX, this value was taken along to limma analysis. If `imputation = no`, NA's for missing values.
